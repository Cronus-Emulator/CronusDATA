map_list = {
	{name = MsgStrID.MSI_MAP_LIST_ALLSELECT,
		list = {{name = MsgStrID.MSI_MAP_LIST_ALLSELECT}},
		ignore_recruit_window = true
	},
	{name = MsgStrID.MSI_MAP_LIST_NAME_PRONTERA,
	list = {{name = MsgStrID.MSI_MAP_LIST_NAME_FILD},
	...
	list = {{name = MsgStrID.MSI_MAP_LIST_NAME_PAY_FILD01, colorR = 255, colorG = 0, colorB = 0},
	...
	list = {{name = MsgStrID.MSI_MAP_LIST_NAME_MJOLNIR01, colorR = 255, colorG = 0, colorB = 0},
	...
	list = {{name = MsgStrID.MSI_MAP_LIST_NAME_TREASURE01},
	...
	list = {{name = MsgStrID.MSI_MAP_LIST_NAME_MOC_FILD01, colorR = 255, colorG = 0, colorB = 0},
	...
	list = {{name = MsgStrID.MSI_MAP_LIST_NAME_IZ_DUN00},
	...
	list = {{name = MsgStrID.MSI_MAP_LIST_NAME_CMD_FILD01},
	...
	list = {{name = MsgStrID.MSI_MAP_LIST_NAME_YUNO_FILD01},
	...
	list = {{name = MsgStrID.MSI_MAP_LIST_NAME_UM_FILD01},
	...
	list = {{name = MsgStrID.MSI_MAP_LIST_NAME_EIN_DUN01},
	...
	list = {{name = MsgStrID.MSI_MAP_LIST_NAME_THA_T01},
	...
	list = {{name = MsgStrID.MSI_MAP_LIST_NAME_GL_CASE01},
	...
	list = {{name = MsgStrID.MSI_MAP_LIST_NAME_RA_FILD01},
	...
	list = {{name = MsgStrID.MSI_MAP_LIST_NAME_NIF_FILD01},
	...
	list = {{name = MsgStrID.MSI_MAP_LIST_NAME_MAN_FILD01},
	...
	list = {{name = MsgStrID.MSI_MAP_LIST_NAME_MEMO_TOWER, colorR = 255, colorG = 0, colorB = 0},
